...
The remainder of this paper is organized as follows. @sec-data describes the dataset and cleaning procedures. @sec-model presents the modeling approach and @sec-results describes empirical results. @sec-discussion discusses findings and limitations and outlines directions for future work.
